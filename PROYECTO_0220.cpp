...
return 0; 
 ...
 //Menú que se le despliega al administrador de la tienda
void menuadmin(){
system("cls");
...
//Menú para actualizar inventario y mostrar el stock de almacen 
void inventario(){
 system("cls");
...
//Una función para agregar los lotes de productos al almacen
 void agregar(){
 system("cls");
    AT PNU;
    ...
    do{
        ...
        cout << "\n1) Rosas unicornio     $2.50\n";
        cout << "2) Girasol de la vida  $2.25\n";
        cout << "3) Clavel de la noche  $4.00\n";
        cout << "4) Abono sencillo      $4.50\n";
        cout << "5) Abono grande        $8.50\n";
        cout << "6) Rastrillos          $6.50\n";
        cout << "7) Palas               $3.99\n";
        cout << "8) salir\n";
        ...
        cin >> cheek; cin.ignore();  
            ...
            switch (cheek){
                ...
                case 1:
                        do{
                            cout << "Digite la c"<<char(160)<<"ntidad: ";
...
//Calcula el gasto que se realiza en la compra de lotes de productos
void ganacia(){
 system("cls");
    float TOTAL;
    ...
    cout << "Ganancia de las ventas: "<< gananciadeventas << endl;
system("pause");
system("cls");
}
...
void cliente(){
 system("cls");
      ...
      do{
          ...
          cout<<"\n\t4) Ir al pago";
          cout<<"\n\t5) Borrar compra";
          cout<<"\n\t6) Regresar al men"<<char(163)<<" principal";
          cout<<"\nDigite su opci"<< char(162)<<"n: ";
          cin>>usuario;
            ...
            switch (usuario){
                ...
                case 3:  cout<<"\n\t\tCompra tus herramientas para tu jard"<<char(162)<<"n:";
                tipherramientas(); break;

                case 4:  factura();  continuar4 = false; break; 

                case 5: eliminarlavida(); break;
            
                case 6:  continuar4 = false; break;
...
void tipplantas(){
 system("cls");
     ...
     do{
            cout<<"\n\t1) Rosas unicornio      $3.50";
            cout<<"\n\t2) Girasol de la vida   $3.25";
            cout<<"\n\t3) Clavel de la noche   $5.00";
        ...
        {
            cout << "\n\t\tLo sentimos" << endl;
            cout << "Datos inv"<<char(160)<<"lidos, trate de nuevo. " <<  endl;
            system("pause");
            system("cls");
        }else{
...
void Totalincliente(){
    ...
    if(client.size() == 0){
      ...
      for(venta i: client){ 
          ...
          TOTALAPAGAR += i.Count_precio; }
     
        cout << "\n\t\t  El Total a pagar es: $ " <<TOTALAPAGAR <<  endl;
        gananciadeventas += TOTALAPAGAR;
...
//Eliminar toda la lista de compra del cliente
void eliminarlavida(){

    int arigato = 0;
    bool loli= true;
    do {
        cout << "Confirmar el borrado de la compra: " << endl;
        cout << "\n\t 1) Confirmar "<< endl;
        cout << "\n\t 2) Cancelar " << endl; 
        cout<<"\nDigite su opci"<< char(162)<<"n: ";
        cin >> arigato ; 
